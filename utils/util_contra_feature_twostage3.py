...
def saveFeatureMaps(net, data_loader, epoch):
    ...
    saveimgs(data, dir='./two_stage_contra_result_SGD/rst/images/00_input_Img',epoch=epoch)

    acts = extract_layers(net, data.to(device))
    saveimgs(acts[0], dir='./two_stage_contra_result_SGD/rst/images/01_cb1_gabor',epoch=epoch)
    saveimgs(acts[1], dir='./two_stage_contra_result_SGD/rst/images/02_cb1_scc',epoch=epoch)
    saveimgs(acts[2], dir='./two_stage_contra_result_SGD/rst/images/03_cb1_conv1',epoch=epoch)
    saveimgs(acts[3], dir='./two_stage_contra_result_SGD/rst/images/04_cb1_conv2',epoch=epoch)
    saveimgs(acts[4], dir='./two_stage_contra_result_SGD/rst/images/05_cb2_gabor',epoch=epoch)
    saveimgs(acts[5], dir='./two_stage_contra_result_SGD/rst/images/06_cb2_scc',epoch=epoch)
    saveimgs(acts[6], dir='./two_stage_contra_result_SGD/rst/images/07_cb2_conv1',epoch=epoch)
    saveimgs(acts[7], dir='./two_stage_contra_result_SGD/rst/images/08_cb2_conv2',epoch=epoch)
    saveimgs(acts[8], dir='./two_stage_contra_result_SGD/rst/images/09_cb3_gabor',epoch=epoch)
    saveimgs(acts[9], dir='./two_stage_contra_result_SGD/rst/images/10_cb3_scc',epoch=epoch)
    saveimgs(acts[10], dir='./two_stage_contra_result_SGD/rst/images/11_cb3_conv1',epoch=epoch)
    saveimgs(acts[11], dir='./two_stage_contra_result_SGD/rst/images/12_cb3_conv2',epoch=epoch)
...
def saveGaborFilters(net, epoch):
    ...
    '''
    if not os.path.exists('./two_stage_contra_result_SGD/rst/images/gaborfilters'):
        os.makedirs('./two_stage_contra_result_SGD/rst/images/gaborfilters')
    ...
    for o in range(channel_out):
        for i in range(channel_in):
            ...
            im.save('./two_stage_contra_result_SGD/images/gaborfilters/%d_cb1_%03d.png'%(epoch, o))
    ...
    for o in range(channel_out):
        for i in range(channel_in):
            ...
            img = (img - img.min())/(img.max()-img.min()+1e-10)*255
            im = Image.fromarray(img.astype("uint8")).convert('L')
            im.save('./two_stage_contra_result_SGD/images/gaborfilters/%d_cb2_%03d.png'%(epoch, o))
    ...
    for o in range(channel_out):
        for i in range(channel_in):
            ...
            img = (img - img.min())/(img.max()-img.min()+1e-10)*255
            im = Image.fromarray(img.astype("uint8")).convert('L')
            im.save('./two_stage_contra_result_SGD/images/gaborfilters/%d_cb3_%03d.png'%(epoch, o))
...
def saveParameters(net, epoch):
    path_rst = './two_stage_contra_result_SGD/'
